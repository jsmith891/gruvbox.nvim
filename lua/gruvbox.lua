...
Gruvbox.palette = {
  ...
  dark_red_medium = "#722529",
  dark_red = "#722529",
  dark_red_soft = "#7b2c2f",
  light_red_hard = "#fc9690",
  light_red_medium = "#fc9487",
  light_red = "#fc9487",
  light_red_soft = "#f78b7f",
  dark_green_hard = "#5a633a",
  dark_green_medium = "#62693e",
  dark_green = "#62693e",
  dark_green_soft = "#686d43",
  light_green_hard = "#d3d6a5",
  light_green_medium = "#d5d39b",
  light_green = "#d5d39b",
  light_green_soft = "#cecb94",
  dark_aqua_hard = "#3e4934",
  dark_aqua_medium = "#49503b",
  dark_aqua = "#49503b",
  dark_aqua_soft = "#525742",
  light_aqua_hard = "#e6e9c1",
  light_aqua_medium = "#e8e5b5",
  light_aqua = "#e8e5b5",
...
local function get_groups()
  ...
  local groups = {
    ...
    GruvboxWhite = { fg = Gruvbox.palette.white },
    ...
    GruvboxYellow = { fg = colors.yellow, bold = config.bold },
    ...
    -- VSCode file icons sit closest to the base foreground tone rather than a syntax accent.
    NvimTreeFileIcon = { fg = colors.fg2 },
    NvimTreeExecFile = { fg = colors.neutral_green, bold = true },
    -- Use the active red token from the shared palette for opened files.
    ...
    -- Indent guides map best to the third background step used for subtle separators.
    ...
    LspInlayHint = { fg = colors.bg4, bg = colors.bg1 },
    ...
    MiniStatuslineModeNormal = { fg = colors.bg0, bg = colors.fg4, bold = config.bold },
    MiniStatuslineModeInsert = { fg = colors.bg0, bg = colors.blue, bold = config.bold },
    MiniStatuslineModeVisual = { fg = colors.bg0, bg = colors.orange, bold = config.bold },
    MiniStatuslineModeReplace = { fg = colors.bg0, bg = colors.red, bold = config.bold },
    MiniStatuslineModeCommand = { fg = colors.bg0, bg = colors.green, bold = config.bold },
    ...
    MiniStatuslineFilename = { fg = colors.fg1, bg = colors.bg1 },
    MiniStatuslineInactive = { fg = colors.fg4, bg = colors.bg1 },
    MiniIndentscopeSymbol = { fg = colors.bg3, nocombine = true },
    ...
    MiniStarterHeader = { fg = colors.orange },
    MiniStarterInactive = { fg = colors.bg4, italic = true },
    MiniStarterItem = { fg = colors.fg1, bg = colors.bg0 },
    MiniStarterItemBullet = { fg = colors.gray },
    MiniStarterItemPrefix = { fg = colors.yellow },
    MiniStarterQuery = { fg = colors.aqua },
    MiniStarterSection = { fg = colors.blue },
    MiniSurround = { link = "IncSearch" },
    MiniTablineCurrent = { fg = colors.fg1, bg = colors.bg0, bold = config.bold },
    MiniTablineFill = { fg = colors.bg4, bg = colors.bg1, reverse = config.invert_tabline },
    MiniTablineHidden = { fg = colors.fg1, bg = colors.bg1, reverse = config.invert_tabline },
    MiniTablineModifiedCurrent = { fg = colors.orange, bg = colors.bg0, bold = config.bold },
    MiniTablineModifiedHidden = { fg = colors.orange, bg = colors.bg1, reverse = config.invert_tabline },
    MiniTablineModifiedVisible = { fg = colors.orange, bg = colors.bg1, reverse = config.invert_tabline },
